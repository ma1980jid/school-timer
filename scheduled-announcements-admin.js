(function(){
  ...
  function createRow(item = {}){
    ...
    row.innerHTML = `
      ...
      <div class="scheduled-row-grid">
        <div class="scheduled-slot"><label>عبارة الصندوق الأيمن</label><textarea class="scheduledRightText" placeholder="تظهر في الصندوق الأيمن">${escapeHtml(slots.rightText)}</textarea></div>
        <div class="scheduled-slot"><label>عبارة الصندوق الأيسر</label><textarea class="scheduledLeftText" placeholder="تظهر ثابتة في الصندوق الأيسر">${escapeHtml(slots.leftText)}</textarea></div>
      </div>
    `;
